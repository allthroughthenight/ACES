...
def wavetrans_imperm(H, T, cotphi, ds, hs, wth, cottheta):
    H = 7.50
    T = 10.00
    cotphi = 100.0
    ds = 10.0
    ...
    if cottheta == 0:
        ...
        assert (reldep > 0.14 and reldep < 0.5), ('Error: d/L conditions exceeded - 0.14<=(d/L)<=0.5')
    else:
...
wavetrans_imperm(0, 0, 0, 0, 0, 0, 0)
