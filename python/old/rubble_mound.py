...
def rubble_mound():
    ...
    tanssl = 1 / cotssl
    Tz = Ts * (0.67 / 0.80)
    ssz = tanssl / math.sqrt(2 * math.pi * Hs / (g * Tz**2))
    ...
    Hm01 = 0.10 * Lp * math.tanh(2 * math.pi * ds / Lp)
    Hm02 = Hs / math.exp(0.00089 * ((ds / (g * (Tp**2)))**(-0.834)))

    Hm0 = min(Hm01, Hm02)

    esp = tanssl / ((2 * math.pi * Hm0 / (g * (Tp**2)))**(1 / 2))
